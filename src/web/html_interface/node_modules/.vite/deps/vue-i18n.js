...
function datetime(context, ...args) {
	...
	if (!isString(args[0]) && !isDate(args[0]) && !isNumber(args[0])) {
		onWarn(getWarnMessage$1(CoreWarnCodes.INVALID_DATE_ARGUMENT, { value: String(args[0]) }));
		return "";
	}
...
function number(context, ...args) {
	...
	if (!isNumber(args[0])) {
		onWarn(getWarnMessage$1(CoreWarnCodes.INVALID_NUMBER_ARGUMENT, { value: String(args[0]) }));
		return "";
	}
